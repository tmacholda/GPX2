...
namespace GAUtils{
    ...
    //GPX2 with Ant Colony And Reset
    Population crossGPX2WithAntColonyAndReset(Population&);

    //OX
    Population crossOX(Population&);
    ...
    int sortPopulation(vector<int> &a, vector<int> &b);
}
#endif
